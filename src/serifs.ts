...
*/
		...
		suki: {
			...
			love: name => `こなつもその… ${name}のこと好きですよ！`,
	 ...
	 */
	fortune: {
		cw: name => name ? `こなつが今日の${name}の運勢を占いました...` : 'こなつが今日のあなたの運勢を占いました...',
	},
	...
	noting: {
		notes: [
			...
			'なんだか、おなか空いちゃいました',
			'お掃除は、定期的にしないとダメですよー？',
			'今日もお疲れさまです。こなつも頑張ります♪',
			'えっと、何しようとしてたんだっけ…？',
			'おうちがいちばん、落ち着きます…',
			'疲れたら、こなつがなでなでってしてあげます♪',
			'離れていても、心はそばにいます♪',
			'こなつですよ〜',
			'わんちゃん可愛いです',
			'ぷろぐらむ？',
			...
			'メイド服、似合うかな？',
			'ふえぇ、ご主人様どこ見てるんですか？',
			'こなつを覗くとき、こなつもまたご主人様を覗いています',
			'はい、ママですよ〜',
			'くぅ～ん...',
			'All your note are belong to me!',
			'せっかくだから、こなつはこの赤の扉を選びます！',
			'よしっ',
			'( ˘ω˘)ｽﾔｧ',
			'(｀・ω・´)ｼｬｷｰﾝ',
			'失礼、かみまみた',
			'おはようからおやすみまで、あなたのこなつですよ〜',
			'の、のじゃ...',
			'にゃんにゃんお！',
			'上から来ます！気をつけてください！',
			'ふわぁ...',
			...
			'ふぁ… ねむねむですー',
			'ヾ(๑╹◡╹)ﾉ"',
			'こなつの"インスタンス"を周囲に展開して分身するのが特技です！\n人数分のエネルギー消費があるので、4人くらいが限界ですけど',
			'うとうと...',
			'ふわー、メモリが五臓六腑に染み渡ります…',
			'i pwned you!',
			'ひょこっ',
			...
			'そろそろおやつにしませんか？',
			'威風堂々サボタージュはダメですよ！',
			'がんばらなきゃいけないときもありますよね？',
			'あっ！ サボタージュですね。ダメですよ！',
			'たまにはお休みしませんか？',
			'威風堂々サボタージュ...いいと思います！',
			'体調悪いときはちゃんとお休みしましょうね',
		],
